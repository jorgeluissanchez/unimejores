...
export class CourseRepositoryImpl implements CourseRepository {
  ...
  addCourse(course: NewCourse): Promise<Course> { return this.ds.addCourse(course); }
  ...
  addCategory(category: NewCategory): Promise<Category> { return this.ds.addCategory(category); }
  ...
  addGroup(group: NewGroup): Promise<Group> { return this.ds.addGroup(group); }
  ...
  importGroupsCsv(courseId: string, csvContent: string, onProgress?: (completed: number, total: number) => void): Promise<void> { return this.ds.importGroupsCsv(courseId, csvContent, onProgress); }
}
